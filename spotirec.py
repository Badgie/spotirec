...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                 epilog=dedent("""
                                 passing no optional arguments defaults to basing recommendations
                                 off the user\'s top genres\nspotirec is released under GPL-3.0 and comes with 
                                 ABSOLUTELY NO WARRANTY, for details read LICENSE
                                 """))
