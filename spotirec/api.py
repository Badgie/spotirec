...
from .log import Log
from .static import API_URL_BASE as URL_BASE
...
class API:
    ...
    def get_top_list(self, list_type: str, limit: int, headers: dict) -> json:
        ...
        """
        params = {'limit': limit}
        response = requests.get(f'{URL_BASE}/me/top/{list_type}', headers=headers,
                                params=params)
    ...
    def create_playlist(self, playlist_name: str, playlist_description: str, headers: dict,
        ...
        response = requests.post(f'{URL_BASE}/users/{self.get_user_id(headers)}/playlists',
    ...
    def upload_image(self, playlist_id: str, data: str, img_headers: dict):
        ...
        """
        response = requests.put(f'{URL_BASE}/playlists/{playlist_id}/images',
    ...
    def add_to_playlist(self, tracks: list, playlist_id: str, headers: dict):
        ...
        response = requests.post(f'{URL_BASE}/playlists/{playlist_id}/tracks',
    ...
    def get_recommendations(self, rec_params: dict, headers: dict) -> json:
        ...
        """
        response = requests.get(f'{URL_BASE}/recommendations', params=rec_params,
                                headers=headers)
    ...
    def get_genre_seeds(self, headers: dict) -> json:
        ...
        """
        response = requests.get(f'{URL_BASE}/recommendations/available-genre-seeds',
                                headers=headers)
    ...
    def play(self, device_id: str, context_uri: str, headers: dict):
        ...
        response = requests.put(f'{URL_BASE}/me/player/play', json=body, headers=headers,
                                params=params)
    ...
    def update_playlist_details(self, name: str, description: str, playlist_id: str, headers: dict):
        ...
        response = requests.put(f'{URL_BASE}/playlists/{playlist_id}', headers=headers,
                                json=data)
    ...
    def replace_playlist_tracks(self, playlist_id: str, tracks: list, headers: dict):
        ...
        """
        data = {'uris': tracks}
        response = requests.put(f'{URL_BASE}/playlists/{playlist_id}/tracks', headers=headers,
                                json=data)
    ...
    def remove_from_playlist(self, tracks: list, playlist_id: str, headers: dict):
        ...
        response = requests.delete(f'{URL_BASE}/playlists/{playlist_id}/tracks',
                                   headers=headers, json=data)
    ...
    def get_saved_tracks(self, headers: dict, limit: int = 50) -> json:
        ...
        """
        params = {'limit': limit}
        response = requests.get(f'{URL_BASE}/me/tracks', headers=headers, params=params)
